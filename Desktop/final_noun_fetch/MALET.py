...
auth_provider = PlainTextAuthProvider(username='kp_cs_ro', password='cskp@ro@12#$')
# host and port
...
# PART 3 - QUERING 
query = "SELECT txt from experience WHERE athr_gndr ='M' allow filtering;"
